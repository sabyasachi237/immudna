...
(function (factory) {
    ...
    $h = {
        ...
        closeButton: function (css) {
            ...
            return '<div class="panel-heading">UPLOAD All FILES</div><button type="button" class="' + css + '" aria-label="Close">\n' +
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: {width: '179px', height: '140px'},
                    text: {width: '179px', height: '140px'},
                    office: {width: '179px', height: '140px'},
                    gdocs: {width: '179px', height: '140px'},
                    video: {width: '179px', height: '140px'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '179px', height: '140px'},
                    object: {width: '179px', height: '140px'},
                    pdf: {width: '100%', height: '140px'},
                    other: {width: '179px', height: '140px'}
                },
                previewSettingsSmall: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: {width: '100%', height: '140px'},
                    text: {width: '100%', height: '140px'},
                    office: {width: '100%', height: '140px'},
                    gdocs: {width: '100%', height: '140px'},
                    video: {width: '100%', height: 'auto'},
                    audio: {width: '100%', height: '30px'},
                    flash: {width: '100%', height: 'auto'},
                    object: {width: '100%', height: 'auto'},
                    pdf: {width: '100%', height: '140px'},
                    other: {width: '100%', height: '140px'}
                },
                previewZoomSettings: {
                    image: {width: 'auto', height: 'auto', 'max-width': '100%', 'max-height': '100%'},
                    html: vDefaultDim,
                ...
                fileActionSettings: {
                    ...
                    downloadIcon: '<i class="fa fa-arrow-circle-o-down"></i>',
