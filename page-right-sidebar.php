...
<html lang="zxx">
    ...
    <body>
									...
									<ul class="navbar-nav m-auto">
										<li class="nav-item">
											...
											<ul class="dropdown-menu">
												<li class="nav-item">
													<a href="index.html" class="nav-link active">Homepage Style One</a>
												</li>

												<li class="nav-item">
													<a href="index-2.html" class="nav-link">Homepage Style Two</a>
												</li>

												<li class="nav-item">
													<a href="index-3.html" class="nav-link">One Page Home</a>
												</li>

												<li class="nav-item">
													<a href="index-4.html" class="nav-link">Boxed Homepage</a>
												</li>

												<li class="nav-item">
													<a href="index-5.html" class="nav-link">Dark Homepage</a>
												</li>
											</ul>
										</li>
										...
										<li class="nav-item">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item">
													<a href="shop-list.html" class="nav-link">Shop List</a>
												</li>
										...
										<li class="nav-item">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item">
													<a href="page-no-sidebar.html" class="nav-link">Page No Sidebar</a>
												</li>
											</ul>
										</li>
			...
			<div class="container">
				<div class="page-title-content">
					...
					<ul>
						...
						<li>Pages</li>
						<li class="active">Page Right Sidebar</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="entry-content ptb-100">
	        <div class="container">
		        <div class="row">
		            <div data-aos="fade-up" data-aos-duration="1200" class="col-lg-8 col-md-12">
                        ...
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus, consectetur magnam aspernatur delectus, maxime inventore soluta nobis nostrum voluptates impedit provident sunt sit ea optio consequatur, quia molestiae voluptatum accusamus Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum id voluptas consequuntur est illo omnis at deserunt sequi excepturi dolorum itaque cum beatae a iure, placeat unde ipsa magni repellat! sit amet consectetur adipisicing elit. Illum id voluptas consequuntur est illo.</p>
				    ...
				    <div class="col-lg-4 col-md-12">
						<div class="blog-details-right-area blog-right-sidebar">
							...
							<div data-aos="fade-up" data-aos-duration="1400" class="blog-widget archives-widget">
							...
							<div data-aos="fade-up" data-aos-duration="1800" class="blog-widget tags-widget mb-0">
		...
		<footer class="footer-bottom-area">
			<div class="container">
				<div class="copy-right">
					<p>Copyright <i class="bx bx-copyright"></i> 2023 Medic - HTML Website Template. All rights reserved.</p>
				</div>
			</div>
		</footer>
