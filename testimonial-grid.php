...
<html lang="zxx">
    ...
    <body>
			...
			<div class="container">
				<div class="page-title-content">
					...
					<ul>
						...
						<li>Pages</li>
						<li class="active">Testimonial Grid</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<section class="testimonial-page bg-color ptb-100">
			<div class="container">
				...
				<div class="row">
					...
					<div data-aos="fade-up" data-aos-duration="2000" class="col-lg-6 col-md-6">
						<div class="single-testimonial">
					...
					<div data-aos="fade-up" data-aos-duration="2200" class="col-lg-6 col-md-6">
